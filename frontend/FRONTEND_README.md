...
- `POST /api/documents/{documentId}/invite?email={email}&inviterId={userId}` - Invite a user (by email) to collaborate; the document will show up under that user's shared documents
